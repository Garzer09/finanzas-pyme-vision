    ...
    <div className="flex flex-col max-w-[960px] flex-1 mx-auto">
      <div className="flex flex-wrap justify-between gap-3 p-4">
        <div className="flex min-w-72 flex-col gap-3">
          <p className="text-[#111518] tracking-light text-[32px] font-bold leading-tight">Análisis de Liquidez</p>
          <p className="text-[#637988] text-sm font-normal leading-normal">Gestión de tesorería y necesidades operativas de financiación</p>
        </div>
      </div>
