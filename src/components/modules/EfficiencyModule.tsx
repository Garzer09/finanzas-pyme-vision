...
import { Zap, TrendingUp, RotateCcw, Target } from 'lucide-react';

export const EfficiencyModule = () => {
  const kpiData = [
    {
      title: 'Rotación Existencias',
      value: '8.2x',
          ...
          <section className="relative">
            <div className="relative bg-white/80 backdrop-blur-2xl border border-white/40 rounded-3xl p-8 shadow-2xl shadow-steel/10 overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-slate-700 text-lg font-medium">Evaluación de rotaciones, ciclos operativos y productividad</p>
              </div>
            </div>
          </section>
