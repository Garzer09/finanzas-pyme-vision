...
('validate_frequency', 'custom', NULL, 'financial_series', '{"allowed_values": ["monthly", "quarterly", "annual"]}', 'Frequency must be monthly, quarterly, or annual', 'error'),
...
('validate_record_type', 'custom', NULL, 'company_profile', '{"allowed_values": ["basic_info", "financial_info", "operational_info", "market_info"]}', 'Record type must be one of: basic_info, financial_info, operational_info, market_info', 'error'),
